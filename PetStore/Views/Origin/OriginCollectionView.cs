...
namespace PetStore.Views.OriginCollectionView{
    public partial class OriginCollectionView : XtraUserControl {
        public OriginCollectionView() {
            InitializeComponent();
        ...
        void InitBindings() {
            ...
            var fluentAPI = mvvmContext.OfType<PetStore.ViewModels.OriginCollectionViewModel>();
     ...
     //               args => (args.Clicks == 2) && (args.Button == System.Windows.Forms.MouseButtons.Left));
            ...
            fluentAPI.WithEvent<GridView, FocusedRowObjectChangedEventArgs>(gridView, "FocusedRowObjectChanged")
                .SetBinding(x => x.SelectedEntity,
                    args => args.Row as PetStore.Origin,
